 ...
 *  PUBLIC METHOD SPECIFICATION:
 *
 *     resize     Resizes the array once the fillLevel becomes the same size as
 *                the max size, leading to the array maxSize needing to be
 *                increased. Increases maxSize it by 10 and then copies works from
 *                the old array into the new larger array.
 ******************************************************************************/
